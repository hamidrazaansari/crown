...
import SpotLightImg1 from '../assets/image/qbiss.jpg';
import SpotLightImg2 from '../assets/image/tabillo.jpg';
import SpotLightImg3 from '../assets/image/kittop.jpg';
import SpotLightImg4 from '../assets/image/aqua-wall.jpg';
  ...
  useGSAP(() => {
    ...
    gsap.to(".scrolling-banner", {
      ...
      scrollTrigger: {
        ...
        scrub: 8, // Smooth animation based on scroll progress
